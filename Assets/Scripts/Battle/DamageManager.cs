...
public class DamageManager : MonoBehaviour
{
    ...
    {
        yield return StartCoroutine(CalculateNumber(first_number_player, second_number_player, sign_player, damage));
    }
    ...
    {
        numberText.rectTransform.DOLocalMoveY(10f, 0.4f)
    ...
    private IEnumerator TurnOffText(TextMeshProUGUI first_number_player, TextMeshProUGUI second_number_player, TextMeshProUGUI sign)
    {
    ...
    TextMeshProUGUI sign, int number)
    {
        ...
        if (number / 10 == 0)
        {
            ...
            yield return StartCoroutine(TurnOffText(first_number_player, second_number_player, sign));
            yield break;
        }
